...
export const translations = {
  nl: {
    ...
    chat: {
      ...
      welcome: 'Welkom bij Oostboek! 👋 Hoe kan ik u vandaag helpen?\n\nKies een onderwerp hieronder of typ uw vraag:',
  ...
  en: {
    ...
    chat: {
      ...
      welcome: 'Welcome to Oostboek! 👋 How can I help you today?\n\nChoose a topic below or type your question:',
